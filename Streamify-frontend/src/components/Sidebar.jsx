...
const Sidebar = ({ closeSidebar = null }) => {
  ...
  return (
    <aside className="h-full w-full flex flex-col">
      <div className="p-5 border-b border-base-300 flex justify-between items-center sticky top-0 bg-base-200 z-10">
        ...
        {closeSidebar && (
          <button className="btn btn-ghost btn-circle lg:hidden" onClick={closeSidebar}>
            <X className="w-6 h-6" />
          </button>
        )}
      </div>
      ...
      <div className="p-4 border-t border-base-300 mt-auto sticky bottom-0 bg-base-200">
